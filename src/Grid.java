...
public class Grid implements IGameObject{
    ...
    private void renderGrid(Graphics2D graphicsRender) {
        graphicsRender.setColor(new Color(0x031927));
    ...
    private void drawEndGameOverlay(Graphics2D graphicsRender) {
        graphicsRender.setColor(new Color(164,212,180, (int)(225 * 0.5f)));
        ...
        graphicsRender.drawString("Press anywhere to restart!", 90, 260);
    }
    ...
    private void placeMarker(int x, int y){
        ...
        if(winLine != null){
            ...
            System.out.println(winType + " WON!");
